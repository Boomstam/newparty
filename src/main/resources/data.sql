...
CREATE SEQUENCE party_sec INCREMENT 1 START 1 MINVALUE 1;
...
VALUES (1, 'Gillende Giraf', 'Antwerpen', 'Zit al gans mijn leven in de zoo van Antwerpen');

INSERT INTO ANIMAL(ID, name, city, bio)
VALUES (2, 'De Olifant', 'Mechelen', 'Geboren en geton Mechelenaar!');
